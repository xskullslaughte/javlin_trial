...
public class App {
    ...
    public static void configureRoutes(Javalin app) {
        ...
        app.get(CovidDashboard.URL, new CovidDashboard());
        app.get(VaccineDashboard.URL, new VaccineDashboard());

        // POST pages can accept form data
        app.post(CovidDashboard.URL, new CovidDashboard());
        app.post(VaccineDashboard.URL, new VaccineDashboard());
    }
